...
from index_schemas import (
    FILM_WORK_INDEX_BODY, GENRE_INDEX_BODY, PERSON_INDEX_BODY
)
...
def load_from_postgres(
        pg_conn: _connection, state_file: str, query: str
) -> list:
    postgres_loader = PostgresLoader(
        pg_conn, state_file=state_file
    )
...
if __name__ == '__main__':
    ...
    def save_elastic(
        ...
        ).create_index(index_schema=index_schema)
